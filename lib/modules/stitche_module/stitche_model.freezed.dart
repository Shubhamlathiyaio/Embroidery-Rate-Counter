...
mixin _$StitcheModel {
  ...
  String get rawStitch => throw _privateConstructorUsedError;
  String get rawHead => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      head: null == head
          ...
          : head // ignore: cast_nullable_to_non_nullable
              as double,
      rawStitch: null == rawStitch
          ? _value.rawStitch
          : rawStitch // ignore: cast_nullable_to_non_nullable
              as String,
      rawHead: null == rawHead
          ? _value.rawHead
          : rawHead // ignore: cast_nullable_to_non_nullable
              as String,
    ) as $Val);
  }
}
...
class _$StitcheModelImpl implements _StitcheModel {
  ...
  final double head;
  @override
  final String rawStitch;
  @override
  final String rawHead;

  @override
  String toString() {
    return 'StitcheModel(key: $key, name: $name, stitch: $stitch, head: $head, rawStitch: $rawStitch, rawHead: $rawHead)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.rawStitch, rawStitch) ||
                other.rawStitch == rawStitch) &&
            (identical(other.rawHead, rawHead) || other.rawHead == rawHead));
  }

  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode =>
      Object.hash(runtimeType, key, name, stitch, head, rawStitch, rawHead);
...
abstract class _StitcheModel implements StitcheModel {
  const factory _StitcheModel(
      ...
      required final String rawStitch,
      required final String rawHead}) = _$StitcheModelImpl;
